...
#elif DARLING // for some reason, this isn't added by default by `configure`
...
#if defined __i386__ &&! defined RUBY_PLATFORM_CPU
#define RUBY_PLATFORM_CPU "i386"
#endif /* defined __i386__ &&! defined RUBY_PLATFORM_CPU */
